...
const rotaUploadBarber = require('./routes/uploadBarber.router');
...
app.use('/clientes', rotaCadastraCliente);
...
app.use('/agendamento', rotaAgendamentos);
app.use('/agendamento/cancelar', rotaAgendamentos);
app.use('/uploads', express.static('src/uploads'));

//rotas de administrador e barbeiros
app.use('/login-barber', rotaBarbeiros);
app.use('/cadastro-usuario', rotaBarbeiros);
app.use('/redefinir-senha-barber', rotaRedefiniPasswordBarber);
app.use('/upload-barber', rotaUploadBarber);
app.use('/agendados', rotaAgendados);
app.use('/faturamento', rotaFaturamento);
app.use('/faturamento-mes', rotaFaturamento);
app.use('/faturamento-periodo', rotaFaturamento);
// app.use('/faturamento', rotaFaturamento);
