...
// tras todos os clientes ordenados por ordem alfabetica
...
const cadastroClientes = async (dados) => {
...
module.exports = { cadastroClientes, getEmail, getClientesAll, updatePass, updateImg };
